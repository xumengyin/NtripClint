...
package com.xu.ntripclint.test;
...
import com.xu.ntripclint.ntrip.NTRIPService;
import com.xu.ntripclint.ntrip.NTrip;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ntrip = new NTrip(this) {
			...
			public void UpdatePosition(double time, double lat, double lon) {
				LogMessage(String.format("Time: %.0f Lat: %.6f� Lon: %.6f�",time,lat,lon));
			}
